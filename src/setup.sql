...
-- Insert dedicated admin testing account
INSERT INTO users (name, email, password_hash, role_id) 
VALUES ('Admin User', 'admin@example.com', '$2b$10$rwctWbdlFy0xFE2pJQCVM.So85fqj2qwKjML0LFbbwnWiFsLRBtPG', (SELECT role_id FROM roles WHERE role_name = 'admin'));
